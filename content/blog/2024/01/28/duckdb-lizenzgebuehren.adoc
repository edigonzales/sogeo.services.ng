...
Man kann das Resulta auch als DuckDB-Tabelle persistieren oder eine View erstellen: `CREATE VIEW v1 AS ...`. Das Resultat als Excel-Datei exportieren, ist auch nur ein `COPY`-Befehl:
