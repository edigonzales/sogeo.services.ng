...
Die LLM können aus verschiedenen Gründen diese Fragen meistens nicht beantworten. Entweder weil sie die Daten nicht verwendet haben. Denke kaum, das sie das &laquo;Das Handbuch der amtlichen Vermessung Kanton Solothurn&raquo; irgendwann verwendet haben oder aber sie wurden anhand nicht mehr aktueller Daten trainiert.
