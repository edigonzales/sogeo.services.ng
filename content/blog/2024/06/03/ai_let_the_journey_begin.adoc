...
Eine einfache Variante mit eigenen Daten zu arbeiten, ist _prompt stuffing_. Dabei werden die Information einfach mit der Frage mitgeschickt. Ein paar Amtschef habe ich in beispielhaft in einer Markdown-Datei erfasst:
