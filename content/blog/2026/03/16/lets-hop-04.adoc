...
:jbake-tags: interlis, apache hop, hop, java, ilivalidator
:idprefix:

Nach _ili2db_ ist vor _ilivalidator_: https://github.com/edigonzales/hop-ilivalidator-plugin. Wahrlich nichts Grossartiges aber ohne geht es natürlich nicht. Auch hier das Beispiel, das alle XTF aus einem Verzeichnis liest und diese einzeln prüft:

image::../../../../../images/lets-hop-04/ilivalidator01.png[alt="Apache Hop", align="center"]

Mit dem &laquo;Get file names&laquo; Transformer lesen wir alle INTERLIS-Transferdateien aus einem Verzeichnis:

image::../../../../../images/lets-hop-04/ilivalidator02.png[alt="Apache Hop", align="center"]

Und dann kommt bereits das ilivalidator-Plugin:

image::../../../../../images/lets-hop-04/ilivalidator03.png[alt="Apache Hop", align="center"]
...
image::../../../../../images/lets-hop-04/ilivalidator04.png[alt="Apache Hop", align="center"]
...
image::../../../../../images/lets-hop-04/ilivalidator05.png[alt="Apache Hop", align="center"]

Im letzten Tab kann man noch das Logfile und die optionalen Output-Felder bestimmen:

image::../../../../../images/lets-hop-04/ilivalidator06.png[alt="Apache Hop", align="center"]

Ein erfolgreicher Run sieht so aus:

image::../../../../../images/lets-hop-04/ilivalidator07.png[alt="Apache Hop", align="center"]
