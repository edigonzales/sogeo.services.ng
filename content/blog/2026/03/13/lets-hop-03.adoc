...
:jbake-tags: interlis, apache hop, hop, java, ili2db
:idprefix:

Es musste ja soweit kommen. Here it is, ein https://github.com/edigonzales/hop-ili2db-plugin[ili2db-Plugin] für _Apache Hop_. Es gibt das Plugin als Action wie auch als Transform. Korrekterweise müsste es wahrscheinlich &laquo;ili2db Input&raquo; heissen, da es sich momentan nur um den Import kümmert. 
...
Was das Plugin (in Teilen kann) erkläre ich am Besten mit einem Transform-Beispiel: Ich möchte alle XTF-Dateien in einem Verzeichnis mit _ili2gpkg_ in GeoPackages umwandeln. Die Pipeline sieht am Ende so aus (&laquo;Text file output&raquo; ist nur noch fürs Debuggen):

image::../../../../../images/lets-hop-03/ili2db01.png[alt="Apache Hop", align="center"]

Als erstes lesen wir alle Dateinamen mit der Endung .xtf aus einem Verzeichnis und bilden den Stream:

image::../../../../../images/lets-hop-03/ili2db02.png[alt="Apache Hop", align="center"]
...
image::../../../../../images/lets-hop-03/ili2db03.png[alt="Apache Hop", align="center"]
...
image::../../../../../images/lets-hop-03/ili2db04.png[alt="Apache Hop", align="center"]

Nun kommt das Spannende. Der Import der Daten in eine GeoPackage-Datei:

image::../../../../../images/lets-hop-03/ili2db05.png[alt="Apache Hop", align="center"]
...
image::../../../../../images/lets-hop-03/ili2db06.png[alt="Apache Hop", align="center"]
...
image::../../../../../images/lets-hop-03/ili2db07.png[alt="Apache Hop", align="center"]

Zu guter Letzt hat der Transformer auch einige Output-Felder:

image::../../../../../images/lets-hop-03/ili2db08.png[alt="Apache Hop", align="center"]

Das Resultat eines gelungenen Pipeline-Runs sieht so aus:

image::../../../../../images/lets-hop-03/ili2db09.png[alt="Apache Hop", align="center"]
