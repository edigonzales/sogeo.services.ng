...
Ich denke schon, dass man gewisse Mehrwerte mit LLM schaffen kann. Vor allem, wenn man auf eigene Daten zugreifen kann. Nun ist das so eine Sache. Bei uns ist halt in der Regal halb richtig, ganz falsch. Wem gehört ein Grundstück? Da gibt es eine richtige Antwort.
